	...
	<script type="text/javascript">
		function getGroupData() {
			...
			$.ajax({
				type : "post",
				async : false, //同步执行  
				url : 'eChartAction_groupPie!getGroupData',
				data : {},
		...
		function getChartDataByIndex(dataIndex) {
			/* 获得图表的options对象   */
			...
			$.ajax({
				type : "post",
				async : false, //同步执行  
				url : 'eChartAction_levelPie!getGroupLevelData?dataIndex='
						+ dataIndex,
				data : {},
				dataType : "json", //返回数据形式为json  
				success : function(data) {
